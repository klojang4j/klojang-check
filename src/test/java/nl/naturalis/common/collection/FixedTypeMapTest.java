...
public class FixedTypeMapTest {
  ...
  public void entrySet00() {
    var m = TypeMap.<String>fixedTypeMapBuilder().add(Object.class,
  ...
  public void values00() {
    var m = TypeMap.<String>fixedTypeMapBuilder()
  ...
  public void copyOf02() {
    Map<Class<?>, String> src = Map.of(Number.class, "Number");
    TypeMap<String> m = TypeMap.fixedTypeMap(src, false);
  ...
  @Test
  public void size00() {
    TypeMap<String> m = TypeMap.fixedTypeMap(Map.of());
  ...
  public void autobox06() {
    TypeMap<String> m = TypeMap.fixedTypeMap(Map.of(Object.class, "Object"));
    assertTrue(m.containsKey(int.class));
    assertEquals("Object", m.get(int.class));
  }
  ...
  @Test
  public void test00() {
    var m = TypeMap.<String>fixedTypeMapBuilder().add(String.class,
  ...
  @Test
  public void test05() {
    var m = TypeMap.<String>fixedTypeMapBuilder().add(ArrayList.class,
  ...
  @Test
  public void test07() {
    var m = TypeMap.<String>fixedTypeMapBuilder().add(List[].class,
  ...
  @Test
  public void test14() {
    var m = TypeMap.<String>fixedTypeMapBuilder().add(A0.class, "A0").add(
        Serializable.class,
        "Serializable").freeze();
