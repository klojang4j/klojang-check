...
public class GreedyTypeMapTest {

  //////////////////////////////////////////////////////////////
  // Specific FixedTypeMap
  //////////////////////////////////////////////////////////////
  @Test
  public void autoExpand01() {
    Map<Class<?>, String> src = Map.of(Integer.class, "Integer");
    var m = TypeMap.<String>greedyTypeMap(src);
  ...
  public void entrySet00() {
    var m = TypeMap.<String>greedyTypeMapBuilder().add(Object.class,
  ...
  public void values00() {
    var m = TypeMap.<String>greedyTypeMapBuilder()
        .add(Object.class,
            "Foo")
  ...
  public void copyOf02() {
    Map<Class<?>, String> src = Map.of(Number.class, "Number");
    var m = TypeMap.<String>greedyTypeMap(src, false);
  ...
  @Test
  public void size00() {
    var m = TypeMap.<String>greedyTypeMap(Map.of());
  ...
  public void autobox06() {
    var m = TypeMap.<String>greedyTypeMap(Map.of(Object.class, "Object"));
    assertTrue(m.containsKey(int.class));
    assertEquals("Object", m.get(int.class));
  }
  ...
  @Test
  public void test05() {
    var m = TypeMap.<String>greedyTypeMapBuilder().add(ArrayList.class,
  ...
  @Test
  public void test07() {
    var m = TypeMap.<String>greedyTypeMapBuilder().add(List[].class,
  ...
  @Test
  public void test10() {
    var m = TypeMap.<String>greedyTypeMapBuilder().autobox(true).add(
        Object.class,
        "Object").freeze();
    assertEquals("Object", m.get(int.class));
  }
  ...
  @Test
  public void test11() {
    var m = TypeMap.<String>greedyTypeMapBuilder().autobox(false).add(
        Object.class,
        "Object").freeze();
    assertEquals("Object", m.get(int.class));
  }
