...
public class MsgPredicateTest {
  ...
  public void int32_00() {
    try {
      ...
      System.out.println(e.getMessage());
      assertEquals("calcium cannot be parsed into an int (was foo)", e.getMessage());
      return;
    }
    fail();
  }
  ...
  public void int32_10() {
    try {
      ...
      System.out.println(e.getMessage());
      assertEquals("calcium must not be parsable into an int (was 42)",
          e.getMessage());
      return;
    }
    fail();
  ...
  @Test
  public void int64_00() {
    try {
      Check.that("foo", "calcium").is(int64());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium cannot be parsed into a long (was foo)", e.getMessage());
      return;
    }
    fail();
  }
  ...
  @Test
  public void int64_10() {
    try {
      Check.that("42", "calcium").isNot(int64());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium must not be parsable into a long (was 42)",
          e.getMessage());
      return;
    }
    fail();
  ...
  @Test
  public void int16_00() {
    try {
      Check.that("foo", "calcium").is(int16());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium cannot be parsed into a short (was foo)",
          e.getMessage());
      return;
    }
    fail();
  ...
  @Test
  public void int16_10() {
    try {
      Check.that("42", "calcium").isNot(int16());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium must not be parsable into a short (was 42)",
          e.getMessage());
      return;
    }
    fail();
  ...
  public void int8_00() {
    try {
      Check.that("foo", "calcium").is(int8());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium cannot be parsed into a byte (was foo)",
          e.getMessage());
      return;
    }
    fail();
  ...
  public void int8_10() {
    try {
      Check.that("42", "calcium").isNot(int8());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium must not be parsable into a byte (was 42)",
          e.getMessage());
      return;
    }
    fail();
  ...
  @Test
  public void float64_00() {
    try {
      Check.that("foo", "calcium").is(float64());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium cannot be parsed into a double (was foo)",
          e.getMessage());
      return;
    }
    fail();
  ...
  @Test
  public void float64_10() {
    try {
      Check.that("42", "calcium").isNot(float64());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium must not be parsable into a double (was 42)",
          e.getMessage());
      return;
    }
    fail();
  ...
  @Test
  public void float32_00() {
    try {
      Check.that("foo", "calcium").is(float32());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium cannot be parsed into a float (was foo)",
          e.getMessage());
      return;
    }
    fail();
  ...
  @Test
  public void float32_10() {
    try {
      Check.that("42", "calcium").isNot(float32());
    } catch (IllegalArgumentException e) {
      System.out.println(e.getMessage());
      assertEquals("calcium must not be parsable into a float (was 42)",
          e.getMessage());
      return;
    }
    fail();
